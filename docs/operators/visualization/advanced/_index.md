...
description: "Higher-dimensional or specialized interactive plots."
weight: 10
categories: [Texera]
tags: [visualization, plotly, charts]
---

Advanced visualizations for complex data exploration.

| Operator | Description |
|----------|-------------|
| [3D Scatter Chart](#3d-scatter-chart) | Three-dimensional scatter plot |
