...
class DatasetResourceSpec
  ...
  "updateDatasetContributors" should "replace the contributor list of the dataset" in {
    ...
    val replacement = List(
      DatasetResource
        .Contributor("Carol", creator = false, "Test Lab C", "contributor-c@test.com", "curation"),
      DatasetResource.Contributor(
        "Dave",
        creator = true,
        "Test Lab D",
    ...
    val response = datasetResource.updateDatasetContributors(
      did,
      DatasetResource.DatasetContributorsModification(replacement),
      sessionUser
    )
  ...
  it should "clear all contributors when given an empty list" in {
    val createdDataset = datasetResource.createDataset(
      DatasetResource.CreateDatasetRequest(
        ...
        contributors = Some(
          List(
            DatasetResource
              .Contributor("Alice", creator = true, "Test Lab A", "contributor-a@test.com", null),
            DatasetResource
              .Contributor("Bob", creator = false, "Test Lab B", "contributor-b@test.com", null)
          )
        )
      ),
      sessionUser
    ...
    val response = datasetResource.updateDatasetContributors(
      did,
      DatasetResource.DatasetContributorsModification(Nil),
      sessionUser
    )
    ...
    assertThrows[BadRequestException] {
      datasetResource.updateDatasetContributors(
        ...
        DatasetResource.DatasetContributorsModification(
          List(
            DatasetResource
              .Contributor("A" * 257, creator = false, "Test Lab A", "contributor-x@test.com", null)
          )
        ),
        sessionUser
      )
    ...
    assertThrows[ForbiddenException] {
      datasetResource.updateDatasetContributors(
        ...
        DatasetResource.DatasetContributorsModification(
          List(
            DatasetResource
              .Contributor("Eve", creator = false, "Test Lab E", "contributor-e@test.com", null)
          )
        ),
    ...
    val createdDataset = datasetResource.createDataset(
      DatasetResource.CreateDatasetRequest(
        ...
        contributors = Some(
          List(
            DatasetResource
              .Contributor("Frank", creator = true, "Test Lab A", "contributor-f@test.com", null)
          )
        )
      ),
      sessionUser
